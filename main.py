...
def main(file_paths, attack_windows = [25,50,75], ending_timestep = 2000):
    ...
    for attack_window in attack_windows:
        ...
        f3_threshold = 0.15   # numerically tested constant
        ...
        output_file = f'AW{attack_window}_results.txt'
